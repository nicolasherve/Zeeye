...
/**
 * Abstract class containing all common operations for UPDATE SQL queries
 * 
...
abstract class UpdateQuery extends SqlQuery {
	...
	/**
	 * Instantiates and returns an object used for UPDATE queries
	 * 
	 * @param string $tableName the name of the table concerned by the UPDATE query
	...
	public static function create($tableName, DbConnection $connection=null) {
		...
		$className = '\Zeeye\Db\Query\\'.$connection->getType().'\\'.$connection->getType().'UpdateQuery';
